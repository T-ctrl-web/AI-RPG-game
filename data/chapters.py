...
# ==============================================================================
# 第一章：语法森林（13 关完整可玩，含 OOP + 文件读写）
# 学完可看懂游戏源码：core/player.py, core/engine.py, data/chapters.py
# ==============================================================================
CHAPTER1_LEVELS = [
    {
    ...
    },
    {
        ...
        "story": "桥断了，需要用 + 号或 f-string 把两段字符串拼接起来才能通过。",
        "knowledge": ["字符串可以用 + 号拼接", "f-string：f'...{变量}...' 更简洁",
                      "数字不能直接和字符串拼接，需要 str() 转换"],
        "monster": "🌉 断桥幽灵", "monster_hp": 70, "reward_exp": 70, "reward_item": "⚡ 加速靴",
        "modes": {
            "teach": {"label": "教学模式", "instruction": "照抄代码，观察 f-string 拼接：",
                      "template": 'name = "勇者"\nprint(f"你好,{name}")', "check_type": "output_exact",
                      "expected": "你好,勇者", "hint": "f-string 用 f 开头，{} 里放变量"},
            "fill": {"label": "填空模式", "instruction": "把 ___ 填成变量名 name：",
                     "template": 'name = "勇者"\nprint(f"你好,{___}")', "check_type": "output_exact",
                     "expected": "你好,勇者", "hint": "___ 填变量名 name"},
            "challenge": {"label": "挑战模式",
                          "instruction": '创建变量 job = "法师"，用 f-string 输出「我的职业是法师」',
                          "template": "", "check_type": "output_exact",
                          "expected": "我的职业是法师", "hint": 'print(f"我的职业是{job}")'},
        },
    },
    {
    ...
    {
        "id": "1-6", "name": "背包列表", "scene": "🎒 背包列表",
        "story": "勇者的背包能装很多装备，用列表 list 来管理这些物品吧！这就是游戏中背包系统的原理。",
        "knowledge": ["列表用方括号 []，元素用逗号分隔", "append() 添加元素，remove() 删除",
                      "len() 获取长度，索引从 0 开始"],
        "monster": "🎒 背包窃贼", "monster_hp": 100, "reward_exp": 100, "reward_item": "🎒 勇者背包",
        "modes": {
            "teach": {"label": "教学模式", "instruction": "照抄代码，理解列表（对应 player.py 的 inventory）：",
                      "template": 'inventory = ["木剑", "木盾"]\ninventory.append("法杖")\nprint(len(inventory))',
                      "check_type": "output_exact", "expected": "3",
                      "hint": "append 添加一个元素，len 返回数量"},
            "fill": {"label": "填空模式", "instruction": "把 ___ 填成 append，添加「药水」：",
                     "template": 'bag = ["剑"]\nbag.___("药水")\nprint(len(bag))',
                     "check_type": "output_exact", "expected": "2", "hint": "___ 填 append"},
            "challenge": {"label": "挑战模式",
                          "instruction": '创建列表 items = ["剑", "盾"]，添加「弓」后打印列表长度',
                          "template": "", "check_type": "output_exact", "expected": "3",
                          "hint": "items.append('弓') 再 print(len(items))"},
        },
    },
    {
        "id": "1-7", "name": "关卡字典", "scene": "📖 关卡字典",
        "story": "每关都有 id、name、monster 等属性，用字典 dict 来存最合适！这就是关卡数据的结构。",
        "knowledge": ["字典用花括号 {}，键值对用冒号 : 分隔", "用 [键] 取值，可以修改",
                      "对应 data/chapters.py 里每关的数据结构"],
        "monster": "📖 字典守护者", "monster_hp": 110, "reward_exp": 110, "reward_item": "📚 字典法典",
        "modes": {
            "teach": {"label": "教学模式", "instruction": "照抄代码，理解字典（对应关卡数据结构）：",
                      "template": 'level = {"id": "1-1", "name": "变量之泉"}\nprint(level["name"])',
                      "check_type": "output_exact", "expected": "变量之泉",
                      "hint": "用 [键] 取对应的值"},
            "fill": {"label": "填空模式", "instruction": "把 ___ 填成键名 name：",
                     "template": 'level = {"id": "1-1", "name": "变量之泉"}\nprint(level["___"])',
                     "check_type": "output_exact", "expected": "变量之泉", "hint": "___ 填 name（不带引号）"},
            "challenge": {"label": "挑战模式",
                          "instruction": '创建字典 hero = {"name":"勇者", "hp":100}，打印 hp 的值',
                          "template": "", "check_type": "output_exact", "expected": "100",
                          "hint": "print(hero['hp'])"},
        },
    },
    {
        "id": "1-8", "name": "函数祭坛", "scene": "⛩️ 函数祭坛",
        "story": "祭坛教你把重复的代码封装成函数，这就是游戏中 render_map、render_battle 的原理！",
        "knowledge": ["def 函数名(参数): 定义函数", "return 返回结果",
                      "函数让代码可复用，对应 ui/ 下的各个函数"],
        "monster": "⛩️ 函数祭司", "monster_hp": 120, "reward_exp": 120, "reward_item": "🔧 函数扳手",
        "modes": {
            "teach": {"label": "教学模式", "instruction": "照抄代码，理解函数（对应 render_map 等）：",
                      "template": 'def attack(power):\n    return power * 2\n\nprint(attack(10))',
                      "check_type": "output_exact", "expected": "20",
                      "hint": "def 定义，return 返回值"},
            "fill": {"label": "填空模式", "instruction": "把 ___ 填成 return，返回 power*2：",
                     "template": 'def attack(power):\n    ___ power * 2\n\nprint(attack(5))',
                     "check_type": "output_exact", "expected": "10", "hint": "___ 填 return"},
            "challenge": {"label": "挑战模式",
                          "instruction": "定义函数 add(a, b) 返回 a+b，调用 add(3, 5) 并打印",
                          "template": "", "check_type": "output_exact", "expected": "8",
                          "hint": "def add(a,b): return a+b"},
        },
    },
    {
        "id": "1-9", "name": "勇者之类", "scene": "🛡️ 勇者之类",
        "story": "勇者是一个「对象」，有名字、HP、攻击力。用 class 来定义勇者！这就是 Player 类的原理。",
        "knowledge": ["class 类名: 定义类", "__init__ 是初始化方法", "self 代表对象自己",
                      "对应 core/player.py 的 Player 类"],
        "monster": "🛡️ 类守护骑士", "monster_hp": 130, "reward_exp": 130, "reward_item": "🎖️ 类之徽章",
        "modes": {
            "teach": {"label": "教学模式", "instruction": "照抄代码，理解类（对应 Player 类）：",
                      "template": 'class Hero:\n    def __init__(self, name):\n        self.name = name\n\nh = Hero("勇者")\nprint(h.name)',
                      "check_type": "output_exact", "expected": "勇者",
                      "hint": "__init__ 初始化，self.name 创建属性"},
            "fill": {"label": "填空模式", "instruction": "把 ___ 填成 self，创建 name 属性：",
                     "template": 'class Hero:\n    def __init__(self, name):\n        ___.name = name\n\nh = Hero("勇者")\nprint(h.name)',
                     "check_type": "output_exact", "expected": "勇者", "hint": "___ 填 self"},
            "challenge": {"label": "挑战模式",
                          "instruction": '定义类 Hero，__init__ 接收 name 参数，创建 h=Hero("法师") 后打印 h.name',
                          "template": "", "check_type": "output_exact", "expected": "法师",
                          "hint": "参考教学模式，把「勇者」换成「法师」"},
        },
    },
    {
        "id": "1-10", "name": "属性与方法", "scene": "⚔️ 属性与方法",
        "story": "勇者能升级、能攻击！这些「能力」就是类的方法。这就是 gain_exp、complete_level 的原理。",
        "knowledge": ["类的方法就是类里面的函数", "用 self.属性 访问对象的数据",
                      "对象.方法() 调用方法，对应 player.gain_exp(50)"],
        "monster": "⚔️ 方法剑圣", "monster_hp": 140, "reward_exp": 140, "reward_item": "💎 方法宝石",
        "modes": {
            "teach": {"label": "教学模式", "instruction": "照抄代码，理解方法（对应 gain_exp）：",
                      "template": 'class Hero:\n    def __init__(self):\n        self.hp = 100\n    def heal(self, n):\n        self.hp += n\n\nh = Hero()\nh.heal(50)\nprint(h.hp)',
                      "check_type": "output_exact", "expected": "150",
                      "hint": "heal 方法修改 self.hp"},
            "fill": {"label": "填空模式", "instruction": "把 ___ 填成 heal，调用治疗方法：",
                     "template": 'class Hero:\n    def __init__(self):\n        self.hp = 100\n    def heal(self, n):\n        self.hp += n\n\nh = Hero()\nh.___(50)\nprint(h.hp)',
                     "check_type": "output_exact", "expected": "150", "hint": "___ 填 heal"},
            "challenge": {"label": "挑战模式",
                          "instruction": "Hero 类有 __init__ 设 hp=100 和 damage(self,n) 方法扣血。创建 h，调用 damage(30)，打印 hp",
                          "template": "", "check_type": "output_exact", "expected": "70",
                          "hint": "self.hp -= n"},
        },
    },
    {
        "id": "1-11", "name": "继承之塔", "scene": "🏰 继承之塔",
        "story": "游戏引擎 GameEngine 继承了基础能力。子类能复用父类的代码，这就是继承！",
        "knowledge": ["class 子类(父类): 实现继承", "子类能用父类的属性和方法",
                      "对应 GameEngine 复用通用逻辑的思想"],
        "monster": "🏰 继承领主", "monster_hp": 150, "reward_exp": 150, "reward_item": "👑 继承王冠",
        "modes": {
            "teach": {"label": "教学模式", "instruction": "照抄代码，理解继承：",
                      "template": 'class Hero:\n    def __init__(self, name):\n        self.name = name\n    def say(self):\n        return f"我是{self.name}"\n\nclass Mage(Hero):\n    pass\n\nm = Mage("法师")\nprint(m.say())',
                      "check_type": "output_exact", "expected": "我是法师",
                      "hint": "Mage 继承 Hero，自动获得 say 方法"},
            "fill": {"label": "填空模式", "instruction": "把 ___ 填成 Hero，让 Mage 继承：",
                     "template": 'class Hero:\n    def __init__(self, name):\n        self.name = name\n    def say(self):\n        return f"我是{self.name}"\n\nclass Mage(___):\n    pass\n\nm = Mage("法师")\nprint(m.say())',
                     "check_type": "output_exact", "expected": "我是法师", "hint": "___ 填 Hero"},
            "challenge": {"label": "挑战模式",
                          "instruction": "定义 Animal 类有 speak() 返回「叫」，Dog(Animal) 继承它。创建 Dog 调用 speak 打印",
                          "template": "", "check_type": "output_exact", "expected": "叫",
                          "hint": "class Dog(Animal): pass"},
        },
    },
    {
        "id": "1-12", "name": "存档之书", "scene": "📜 存档之书",
        "story": "勇者的进度需要保存！用 json 把对象存成文件，下次能读回来。这就是存档系统的原理！",
        "knowledge": ["json.dump() 把数据写入文件", "json.load() 从文件读取",
                      "open('文件', 'w'/'r') 打开文件，对应 save/player.json"],
        "monster": "📜 存档守护者", "monster_hp": 160, "reward_exp": 160, "reward_item": "💾 存档水晶",
        "modes": {
            "teach": {"label": "教学模式", "instruction": "照抄代码，理解 json 存档（对应 player.py 的 save）：",
                      "template": 'import json\ndata = {"name": "勇者", "level": 1}\nwith open("save.json", "w") as f:\n    json.dump(data, f)\nprint("已保存")',
                      "check_type": "output_exact", "expected": "已保存",
                      "hint": "json.dump 把字典写入文件"},
            "fill": {"label": "填空模式", "instruction": "把 ___ 填成 dump，写入文件：",
                     "template": 'import json\ndata = {"name": "勇者"}\nwith open("save.json", "w") as f:\n    json.___(data, f)\nprint("已保存")',
                     "check_type": "output_exact", "expected": "已保存", "hint": "___ 填 dump"},
            "challenge": {"label": "挑战模式",
                          "instruction": "把字典 {\"hp\":100} 用 json 存入 test.json，打印「OK」",
                          "template": "", "check_type": "output_exact", "expected": "OK",
                          "hint": "import json; with open... json.dump..."},
        },
    },
    {
        "id": "1-13", "name": "BOSS：源码巨龙", "scene": "🐉 源码巨龙巢穴",
        "story": "最终 BOSS！它守护着游戏源码的秘密。你需要综合运用所有知识，写出一个迷你的勇者类！",
        "knowledge": ["综合：类 + 方法 + 列表 + json", "这就是 player.py 的核心结构",
                      "通关后你能看懂整个 player.py"],
        "monster": "🐉 源码巨龙", "monster_hp": 200, "reward_exp": 300, "reward_item": "💎 语法晶石",
        "is_boss": True,
        "modes": {
            "teach": {"label": "教学模式", "instruction": "照抄代码：一个迷你勇者类（player.py 的雏形）：",
                      "template": 'class Hero:\n    def __init__(self, name):\n        self.name = name\n        self.hp = 100\n        self.bag = []\n    def gain(self, item):\n        self.bag.append(item)\n\nh = Hero("勇者")\nh.gain("剑")\nprint(len(h.bag))',
                      "check_type": "output_exact", "expected": "1",
                      "hint": "综合运用 __init__、self、append"},
            "fill": {"label": "填空模式", "instruction": "把两处 ___ 填好（self 和 append）：",
                     "template": 'class Hero:\n    def __init__(self, name):\n        self.name = name\n        self.bag = []\n    def gain(self, item):\n        ___.bag.___(item)\n\nh = Hero("勇者")\nh.gain("剑")\nprint(len(h.bag))',
                     "check_type": "output_exact", "expected": "1", "hint": "第一处填 self，第二处填 append"},
            "challenge": {"label": "挑战模式",
                          "instruction": "定义 Hero 类：__init__ 设 name 和空 bag 列表；gain(item) 方法往 bag 加物品。创建勇者，加「剑」，打印 bag 长度",
                          "template": "", "check_type": "output_exact", "expected": "1",
                          "hint": "参考教学模式，自己写完整"},
        },
    },
]
